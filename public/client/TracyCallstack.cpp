...
// when we have access to dl_iterate_phdr(), we build a cacheo faddress ranges to image paths so we can quickly determine
// which image an address will fall into.
